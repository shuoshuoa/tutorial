...
/**
 * Created by wangshuo on 16/2/19.
 */
...
//    private ScheduledFuture<?> beeperHandle1,beeperHandle2;
...
//
//            beeperHandle1 = scheduler.scheduleAtFixedRate(new Runnable() {
//                @Override
//                public void run() {
//                    try {
...
//
//            beeperHandle2 = scheduler.schedule(new Runnable() {
//                @Override
//                public void run() {
